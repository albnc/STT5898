...
#df <- rbind(df, c("Alberto", "São Carlos, SP", "blue"))
# df <- rbind(df, c("Andressa", "São Carlos, SP", "blue"))
# df <- rbind(df, c("Ellen", "São Carlos, SP", "blue"))
#df <- rbind(df, c("Felipe", "Bauru, SP", "blue"))
# df <- rbind(df, c("Fernando", "São Carlos, SP", "blue"))
# df <- rbind(df, c("Gabriela", "São Carlos, SP", "blue"))
# df <- rbind(df, c("João Pedro", "São Carlos, SP", "blue"))
# df <- rbind(df, c("Maria Eduarda", "São Carlos, SP", "blue"))
# df <- rbind(df, c("Mariana", "São Carlos, SP", "blue"))
# df <- rbind(df, c("Rodrigo", "Curitiba, PR", "blue"))
#df <- rbind(df, c("Sergio", "Salvador, BA", "blue"))
...
- Aulas às sexta-feiras das 9h ~ 12h
...
- Pedro Caliari: <pedro.caliari@usp.br>
